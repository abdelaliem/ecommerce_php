...
<body>
            ...
            <div class="left-side-img d-flex m-5">
                ...
                <section class="w-50">
                    ...
                    <div class="pp d-flex align-items-center">
                        <div class="d-flex align-items-center justify-content-between p-2 rounded w-25" style="border: 1px solid gray; margin-right: 50px">
                            <button id="MinusButton" class="btn">-</button>
                            <span id="count" class="fs-4">1</span>
                            <button id="PlusButton" class="btn">+</button>
                        </div>
                        <div>
                            <button class="btn btn-outline-dark p-3" style="
    ...
    <br />
    <div style="border: 1px solid rgba(217, 217, 217, 1); width: auto; top: 1031px"></div>
    <br />
    <div class="container">
        <center>
            <strong>
