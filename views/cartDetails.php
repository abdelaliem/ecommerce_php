          ...
          <div class="col-md-6">
            ...
            <div class="row" style="width:120%;">
              ...
              <div class=" col-md-2 d-flex align-items-center justify-content-between rounded border p-2" style=" max-height:44px;">
                <button class="btn" id="MinusButton" style="color: black; font-size: x-large;">&minus;</button>
                <input type="text" id="count" value="1" class="quantity-input fs-4 w-25 text-center border-0" style="color: black;">
                <button class="btn" id="PlusButton" style="color: black; font-size: x-large;">+</button>
              </div>
